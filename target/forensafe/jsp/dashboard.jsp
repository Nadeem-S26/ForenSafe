  ...
  <div class="page-body">
    ...
    <div class="page-header">
      <div>
        ...
        <div class="page-subtitle">// FORENSAFE COMMAND CENTER &mdash; REAL-TIME OVERVIEW</div>
      </div>
    </div>
    <!-- Stat Cards -->
    <div class="stats-grid">
      ...
      <a href="<%= request.getContextPath() %>/overdue" class="stat-card" style="--card-accent:var(--danger);border-top-color:var(--danger);text-decoration:none;cursor:pointer">
        <div class="stat-icon">⚠️</div>
        <div class="stat-value" style="color:var(--danger)">${overdueCount}</div>
        <div class="stat-label" style="color:var(--text-muted)">Overdue Alerts</div>
        <div class="stat-meta">Evidence stuck in lab</div>
      </a>
    </div>
