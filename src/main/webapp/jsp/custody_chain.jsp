...
<div class="main-content">
  <div class="topbar">
    ...
    <span class="topbar-title">🔗 Chain of Custody</span>
  ...
  <div class="page-body">
    ...
    <div class="page-header">
      <div>
        <div class="page-title">Evidence: ${evidence.evidenceId}</div>
        <div class="page-subtitle">${evidence.caseTitle} · ${evidence.evidenceType}</div>
      </div>
