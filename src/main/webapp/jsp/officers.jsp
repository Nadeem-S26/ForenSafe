...
<div class="main-content">
  <div class="topbar">
    ...
    <span class="topbar-title">👮 Officer Management</span>
  ...
  <div class="page-body">
    ...
    <div class="page-header">
      <div>
        <div class="page-title">Officer Registry</div>
        <div class="page-subtitle">Manage system users and forensic officers</div>
      </div>
